...
//checkofferview2 checks for new offer views to deflate every 10secs
	...
	$offerhash1 = 'BJpqgFHuEcx';//Bank Transfer
	$offerhash2 = 'BJpqgFHuEcx';//Bank Transfer
	$offerhash3 = 'BJpqgFHuEcx';//Bank Transfer
	...
	$offerhash1r = '23qK8rqjTQr';//International Wire Transfer (SWIFT)PqKjivovJ6n
	$offerhash2r = 'yexy3jqVEyC';//Domestic Wire Transfer
	$offerhash3r = 'K4GczhJBYH2';//Cash Deposit to Bank
